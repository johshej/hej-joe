...
class CardColor
{
    ...
    public static function fromValue(?int $value): string
    {
        ...
        return match (true) {
            $value < 0 => 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200',
            $value === 0 => 'bg-zinc-100 text-zinc-600 dark:bg-zinc-700 dark:text-zinc-300',
            $value <= 4 => 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200',
